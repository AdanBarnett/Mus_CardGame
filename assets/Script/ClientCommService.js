  ...
  onExtensionResponse(event) {
    ...
    switch (messageType) {
      ...
      case MESSAGE_TYPE.SC_DO_END_ROUND:
        GameScene.doEndRound(params.coins_history, params.round_coins, params.total_coins, params.endMission, params.mission_score, params.points, params.winner, params.win_cards, params.allIn);
        break;
